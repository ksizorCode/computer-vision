...
# Permite cambiar entre varios modelos 3D y ajustar su tamaño y color
# ----------------------------------
# Requiere OpenCV 4.7.0 o superior con módulos ArUco
# ----------------------------------
...
def project_3d_model(vertices, faces, rvec, tvec, camera_matrix, dist_coeffs, scale=0.02):
    ...
    try:
        ...
        print(f"Error proyectando modelo: {e}")
        return np.array([])
